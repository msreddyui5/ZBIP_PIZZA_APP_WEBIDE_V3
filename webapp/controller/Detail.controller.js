...
sap.ui.define([
		...
		return BaseController.extend("pizza.controller.Detail", {
			...
			_bindView : function (sObjectPath) {
				...
				//obtain the object of simple form which is inside the icon tab filer
				var oIconTabFilter = this.getView().byId("iconTabBarFilter1");
				var oForm = oIconTabFilter.getContent()[0];
				oForm.bindElement(sObjectPath,{
					expand: 'ToOrderCustomer,ToOrderDelivery'
				});
